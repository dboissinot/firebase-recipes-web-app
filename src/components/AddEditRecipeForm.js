...
function AddEditRecipeForm({handleAddRecipe}){
        ...
        <div className="fields">
            ...
            <label className="recipe-label input-label">
                ...
                >
                    ...
                    <option value="dessertsAndBakedGoods">Desserts & Baked Good</option>
    ...
    <div className="ingredients-list">
        ...
        </table>
        {
            ...
            <h3 className="text-center no-ingredients">No Ingredients Added yet
            </h3>
            ) : null}
            <div className="ingredient-form">
                    <label className="ingredient-label">
                     ...
                     <button type="button" className="primary-button add-ingredient-button" 
